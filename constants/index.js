...
const generateTimeStamp = () => new Date().getTime(),
  IS_SCHEMA = `_schema_id_@_${generateTimeStamp()}_@_`,
  IS_FORMREF = `${IS_SCHEMA}_ref`,
  IS_MULTIPLE = `${IS_SCHEMA}_multiple`,
  PRIMITIVE_VALUE = "_schema_id_@__literal_@_",
  SCHEMA_CONFIG = `${IS_SCHEMA}_config`,
  ON_CHANGE = "onChange",
  ON_BLUR = "onBlur",
  VALUE = "value",
  ERROR = "error",
  ...
  TYPE_ERROR = "error",
  TYPE_SYMBOL = "symbol",
  TYPE_GENERATOR_FUNCTION = "generatorFunction";
(exports.ERROR = ERROR),
  ...
  (exports.TYPE_GENERATOR_FUNCTION = "generatorFunction"),
  (exports.TYPE_NULL = "null"),
  (exports.TYPE_OBJECT = "object"),
  (exports.TYPE_STRING = "string"),
  (exports.TYPE_SYMBOL = "symbol"),
