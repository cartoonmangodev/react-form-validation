...
var FormConsumer = (_ref2 => {
  let {
    children,
    ...props
  } = _ref2;
  return /*#__PURE__*/React__default.createElement(Consumer, useConsumerHook(props), children);
});
...
const formValidationHandler = function () {
  ...
  const useFormValidationHook = _ref18 => {
    ...
    const [{
      formRef,
      formId
    }] = React.useState(() => _formValidationHandler({
      ...props,
